...
namespace CSharpAdvanceTraining
{
     ...
     *	Protected Internal--> To provide access with in the project that contains the class defination and to the derived classes.
     * 
    ...
    */
    ...
    //class ProtectedStudent : Student
    //{
    //    public void test()
    //    {
    //        disp();
    ...
    //{
    //    ProtectedStudent a = new ProtectedStudent();
    ...
    //                     //			can be accessed from the same project and not from outside the project.
    //    }
    ...
    //        ProtectedCustomer customer = new ProtectedCustomer("test");
    //        customer.SetNameProtected("New Name");
    //    }
