...
namespace CSharp
{
   ...
   //	*/
    ...
    //     class InterfaceImplementation : Ishape
    //     {
    //         public double Area() => 0;

    //         public void DisplayDetail() =>
    //             Console.WriteLine("This is the Area Method from {0}", nameof(InterfaceImplementation));
    ...
    //         public void DisplayDetail() =>
    //             Console.WriteLine("This is from the method: {0}", nameof(Circle));
    //     }
    ...
    //         public void DisplayDetail() =>
    //             Console.WriteLine("This is from the method : {0}", nameof(Square));
